...
**① 法条检索 → 引用卡片**（全部视图可用）：跨 108 部受控语料（10,669 条条文条目）的 BM25 检索，每条结果带来源、时效与证据等级；摘要只显示程序统计，不调用生成模型。
...
| 法条浏览与 BM25 检索 | 由仓库内证据快照构建；当前构建产物为 108 部、10,669 条文条目（2026-09-18 起，条目破万；新增村民委员会组织法（2025 修正）、城市居民委员会组织法（2025 修正，基层自治双法同日修正）、体育法（2022 修订）——R163 基层自治与体育批；新增法治宣传教育法（2025 新制定）、国防教育法（2024 修正）、农业法（2012 修正现行，2026 修订尚未生效如实注记）——R162 普法国防与农业批；新增学前教育法（2024）、种子法（2021 修订）、爱国主义教育法（2023）——R161 学前种子与爱国批；新增无障碍环境建设法（2023）、医疗保障法（2026 公布 2027 施行，尚未生效诚实标注）、环境保护税法（2025 修正）——R160 无障碍医保与绿税批；新增计量法（2018 修正）、标准化法（2017 修订）、促进科技成果转化法（2015 修正）——R159 计量标准与成果批；新增档案法（2020 修订）、动物防疫法（2021 修订）、科学技术进步法（2021 修订）——R158 档案动物与科技批；新增矿山安全法（2009 修正）、乡村振兴促进法（2021）、医师法（2021，承继已废止执业医师法）——R157 安全三农与医疗批；新增职业教育法（2022 修订）、母婴保健法（2017 修正）、监狱法（2012 修正）——R156 职业健康与执行批；新增高等教育法（2018 修正）、慈善法（2023 修正）、特种设备安全法（2013）——R155 教育慈善与安全批；新增工会法（2021 修正）、献血法（1997）、中医药法（2016）——R154 劳动与健康批；新增教育法（2021 修正）、社区矫正法（2019）、邮政法（2015 修正）——R153 教育与民生批；新增疫苗管理法（2019）、英雄烈士保护法（2018）、人口与计划生育法（2021 修正）——R151 民生保护批，及精神卫生法（2018 修正）、禁毒法（2008）、农村土地承包法（2018 修订）——R152 民生保护第二批；新增道交法、劳动法、产品质量法、食品安全法 2025 修正、预防未成年人犯罪法、老年人权益保障法、人民调解法、广告法、消防法、药品管理法与著作权/专利/商标知识产权三法）；含宪法、刑法，优先登记册 backlog 清零）。2026-09-13/14 大幅扩张：新增治安管理处罚法（2025 修订）、未成年人保护法（2024 修正）、妇女权益保障法（2022 修订）、行政处罚法（2021 修订）、网络安全法（2025 修正）、数据安全法（2021）、劳动争议调解仲裁法（2007）、刑事诉讼法（2018 修正）、国家赔偿法（2012 第二次修正）、宪法（2018 修正）、刑法（2023 第十二次修正）、反家庭暴力法（2016 施行）、社会保险法（2018 修正）、食品安全法（2021 修正）等 14 部法律。此前新增个人信息保护法、法律援助法、行政复议法和行政诉讼法的全国人大官方快照；2026-09-13/14 新增治安管理处罚法（2025 修订）、未成年人保护法（2024 修正）、妇女权益保障法（2022 修订）、行政处罚法（2021 修订）、网络安全法（2025 修正，网信办重新公布文本）、数据安全法（2021，网信办受权发布）、劳动争议调解仲裁法（2007，国家信访局法律法规库）、刑事诉讼法（2018 修正）、国家赔偿法（2012 第二次修正）、宪法（2018 修正）与刑法（2023 第十二次修正）官方公报转载/转录快照。页面提供来源、快照日期、文件哈希、施行/版本日期证据。全国人大截至 2026-03-16 的目录载明 310 件现行有效法律；两者统计口径不同，本项目不是完整中国法律数据库，也没有完整历史版本全库（已采集 37 版历史全文，版本 Tab 可对照查阅）。 |
...
六工具：`search_articles`（BM25 全文检索法条原文）、`get_article`（按 ID+条号取原文与元数据）、`list_laws`（语料清单）、`search_cases`（指导案例与域外判例检索）、`search_history`（历史版本文本独立检索，非现行仅供对照）、`get_xrefs`（法条双向交叉引用导航，660 条已验证引用）。**只暴露检索，无任何生成型工具**；输出永远为法条原文+元数据+官方来源 URL，并声明「不构成法律意见」。HTTP 端点 `POST /mcp` 亦可用（JSON-RPC 2.0）。

## 开放数据

- `web/public/data/laws-md/`：108 部法律全语料 markdown 导出（每法一文件，含官方元数据），与 `data/laws.json` 同源。
- [llms.txt](web/public/llms.txt) / [llms-full.txt](web/public/llms-full.txt)：LLM 友好的语料索引与全文。
