...
- `web/public/data/laws-md/`: full-corpus markdown export (49 instruments, one file per law, with official metadata headers), same source as `data/laws.json`.
