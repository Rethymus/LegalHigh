...
- `web/public/data/laws-md/`: full-corpus markdown export (63 instruments, one file per law, with official metadata headers), same source as `data/laws.json`.
