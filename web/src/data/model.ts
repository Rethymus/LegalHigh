...
export const DATA_SOURCES: DataSource[] = [
  { name: '本地证据快照语料（Wikisource 转录 + gov.cn）', kind: 'Official Legislation（快照）', jurisdiction: '中国', status: '已接入（本地快照）', freq: '随 build_corpus.py 构建', last: '2026-08-29', docs: '8 部法律 · 1,953 条', verify: '结构校验通过 · flk 抽查比对待完成（M6：人工抽查≥10%+字段全量，不爬取）', strategy: 'P0（进行中）：证据快照 → 结构校验 → 导出', note: '民法典/消保法/消保条例/劳动合同法/律师法/电商法/民诉法(2023)/生成式AI办法' },
  ...
  { name: '国家法律法规数据库（flk.npc.gov.cn）', kind: 'Official Legislation', jurisdiction: '中国', status: '规划接入', freq: '—', last: '—', docs: '—', verify: '—', strategy: 'P1：现行有效文本与效力信息的权威对照基准（M6：人工抽查≥10%+字段级全量对照；无开放 API，不批量抓取——红线7）' },
