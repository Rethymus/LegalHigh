...
- AI-generated content labeling compliance draft (S6-T2): design document mapping the AI content labeling measures (effective 2025-09-01) onto the project's tiered AI-expansion policy — explicit page-level marks and implicit metadata marks for any future public AI output (docs/compliance/AI生成内容标识合规预案-设计稿.md).
